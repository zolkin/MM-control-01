...
static const uint16_t eepromBowdenLenDefault = 20000u; //!< Default bowden length (~960 mm)
static const uint16_t eepromBowdenLenMinimum = 6900u; //!< Minimum bowden length (~341 mm)
static const uint16_t eepromBowdenLenMaximum = 64000u; //!< Maximum bowden length (~3168 mm)
